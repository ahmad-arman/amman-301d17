...
function displayPics(){
  ...
  // happen error because const is local var  defined just inside while if the declaration outside while , can not defined to program if change it to var every thing is good because var global var.
  console.log(viewed);
